  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: get(reference, 'isPrivate') ? 'var(--secondary)' : 'var(--accent)',
      }}
    ...
    >
      ...
      {currentUser && draggable && (
        <span ref={drag}>
          <DragIndicatorOutlined className={isDragging ? 'text-primary' : 'text-input'} style={{ cursor: 'move' }} />
        </span>
      )}
      ...
      >
        ...
        >
          <div className="flex flex-col gap-2">
            <button className="mr-1 pt-1 text-input text-left hover:cursor-pointer" href="#" onClick={onLinkClick}>
              <span className="text-md text-input underline">{get(reference, 'title')}</span>
            </button>
