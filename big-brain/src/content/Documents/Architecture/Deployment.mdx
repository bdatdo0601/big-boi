...
- [Amplify](https://aws.amazon.com/amplify/): Used to orchestrate all AWS resources. It has support for CreateReactApp (Refer too [[Web Framework]]), couple of AWS official resource support and ability to write custom CloudFormation if needed
