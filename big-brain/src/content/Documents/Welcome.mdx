...
This is my documentation/research/brain-storming playground. This will be directly available on my main website as well (as an Iframe).
...
- [Vercel](https://vercel.app/) with automated deployment through [Github Actions](https://github.com/marketplace/actions/vercel-action): Which allows me to (freely) deploy this to a public domains
...
Not sure if I would combine the two in the future but the way I see it: Blogs would be more opinionated while this would be more data-based and research-heavy.
