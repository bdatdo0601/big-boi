...
const TreeItem = ({ item, level = 0, pathPrefix = '/docs/doc/' }: TreeItemProps) => {
  ...
  if (item.type === 'directory') {
    return (
      <div className="ml-1">
        <div className="font-semibold my-2 flex items-center cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
  ...
  return (
    <Link
      ...
      className={`block ml-2 py-1 hover:bg-popover-foreground text-nowrap border-none ${
